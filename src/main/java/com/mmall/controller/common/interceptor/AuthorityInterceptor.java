...
public class AuthorityInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(StringUtils.equals(className,"UserManageController") && StringUtils.equals(methodName,"login")){
            ...
            return true;    //返回true，进入controller
        }
        ...
        if(user == null || (user.getRole().intValue() != Const.Role.ROLE_ADMIN)){   //可能出现的越权状况
            ...
            PrintWriter out = response.getWriter();//?????通过respons.getwriter()把输出拦截，再返回给客户端
            ...
            return false;   //返回false，不需要进入controller
